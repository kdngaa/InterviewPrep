...
//in order to post, put, delete, you have to use the option section of the fetch method (after the url), which includes the headers (content type application json ) and body (**which has to be stringified from JSON**) and the method you intend to use

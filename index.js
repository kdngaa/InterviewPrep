...
//since we want to delete the actual item from the list, we must use this.parentNode since the item is the parent of the X button, hence it'll delete the whole item

...
//in order to post, put, delete, you have to use the option section of the fetch method (after the url), which includes the body and the method you intend to use
